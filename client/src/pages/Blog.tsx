...
export const BLOG_POSTS = [
  ...
  },
  {
    ...
    title: "How to read your child's NAPLAN results: a parent's honest guide",
    subtitle: "What Exceeding, Strong, Developing and Needs additional support actually mean, and what to do next",
    date: "July 2026",
    readTime: "5 min read",
    category: "NAPLAN",
    categoryColor: "#EAF3DE",
  ...
  {
    slug: "naplan-anxiety-helping-your-child",
    title: "NAPLAN anxiety: how to help your child stay calm",
    subtitle: "The signs to watch for, what genuinely helps, what to avoid, and when to seek support",
    date: "July 2026",
    readTime: "7 min read",
    category: "NAPLAN",
    categoryColor: "#EAF3DE",
    categoryTextColor: "#4A7515",
    excerpt: "A calm, evidence-based guide to NAPLAN anxiety: the signs to watch for, what actually helps, what to avoid, and when to seek support.",
  },
  {
    slug: "luna-vs-leo",
