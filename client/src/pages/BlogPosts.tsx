  ...
  return (
    <BlogLayout post={post}>
      ...
      <div className="blog-body">
        ...
        <p>ClassUp starts with a free 30-minute diagnostic that maps your child's performance across three NAPLAN domains: <Link href="/naplan-year-5-numeracy" style={{ color: "#7F77DD", fontWeight: 600 }}>Numeracy</Link>, <Link href="/naplan-year-5-reading" style={{ color: "#7F77DD", fontWeight: 600 }}>Reading</Link>, and Language Conventions. The diagnostic does not just score them. It identifies the specific sub-skills that are weak, so the coaching that follows is targeted from the first session.</p>
  ...
  return (
    <BlogLayout post={post}>
      ...
      <div className="blog-body">
        ...
        <p>Many children are strong at locating and retrieving but weaker at the higher-order processes. A child who reads fluently but scores below expectation in <Link href="/naplan-year-5-reading" style={{ color: "#7F77DD", fontWeight: 600 }}>Reading</Link> is usually struggling with integrating and evaluating, not with reading itself.</p>
        ...
        <p>The most useful thing you can do with this breakdown is identify which domain and which sub-domain is weakest for your child, and then focus preparation time there. A child who is strong in <Link href="/naplan-year-5-reading" style={{ color: "#7F77DD", fontWeight: 600 }}>Reading</Link> and <Link href="/naplan-year-5-language-conventions" style={{ color: "#7F77DD", fontWeight: 600 }}>Language Conventions</Link> but weak in <Link href="/naplan-year-5-numeracy" style={{ color: "#7F77DD", fontWeight: 600 }}>Numeracy</Link> should spend most of their preparation time on Numeracy, specifically on the sub-domain where the gap is largest. Generic practice papers spread time evenly across all domains, which is inefficient if the gaps are concentrated in one area.</p>
        <InPostCTA />
      </div>
    </BlogLayout>
  );
